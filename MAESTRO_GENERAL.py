...
filepath = 'C:/Users/PC - Usuario/Desktop/PRUEBAS_ETL/TABLAS/Maestro_general.csv' 
...
# separador = detectar_separador_montos(filepath) 
dfm= pd.read_csv(filepath, delimiter = ';', encoding='unicode-escape') 
     ...
     class MAESTRO_GENERAL(): 
          ...
          def Grabar(self, dfm): 
               ...
               for index, row in dfm.iterrows():  
                    ...
                    cursor.execute(Insert,(self.COD_PROD, self.DESC_PROD, self.EAN_13, self.CATEGORIA_PROD, self.FAMILIA_PROD, self.MARCA_PROD, self.SEGMENTO_PROD, self.UND_X_CAJA, self.PESO_X_UND, self.PRESENTACION_PROD,self.ESTADO_PROD))
               conexion.commit() 
               conexion.close()
